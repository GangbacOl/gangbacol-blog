...
import { register as _register } from "../../apis/auth";
    ...
    <Container>
      <RegisterBox>
        <HookForm onSubmit={handleSubmit(onSubmit)}>
          <TextInput placeholder="이름을 입력해주세요." {...register("username", { required: true })} />
          <br />
          <TextInput placeholder="아이디를 입력해주세요." {...register("account", { required: true })} />
          <br />
          <TextInput
            type="password"
